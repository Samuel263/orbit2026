...
export function SiteNav({ language }: Props) {
  ...
  return (
    <div className={`fixed left-0 right-0 z-40 px-3 sm:px-6 md:px-10 transition-all duration-300 ${scrolled ? "top-3 sm:top-4" : "top-3 sm:top-6 md:top-8"}`}>
      <header className="mx-auto max-w-3xl flex items-center justify-between gap-3 sm:gap-4 pl-2 pr-1.5 sm:pl-3 sm:pr-2 py-1.5 sm:py-2 rounded-[20px] border border-white/10 backdrop-blur-xl bg-[#1A1A1A]/80">
